...
public class ServerConfig : MonoBehaviour
{
    ...
    [SerializeField] private string serverIP = "your-server.example.com";
    ...
    void Start()
    {
        ...
        // 강제로 서버 주소 설정 (테스트용)
        PlayerPrefs.SetString(SERVER_IP_KEY, "your-server.example.com");
    ...
    /// <summary>
    /// HTTP URL 가져오기 (예: https://your-server.example.com:443)
    /// </summary>
    public static string GetHttpUrl()
    {
        string ip = PlayerPrefs.GetString(SERVER_IP_KEY, "your-server.example.com");
        int port = PlayerPrefs.GetInt(SERVER_PORT_KEY, 443);
        return $"https://{ip}:{port}";
    }

    /// <summary>
    /// WebSocket URL 가져오기 (예: wss://your-server.example.com:443)
    /// </summary>
    ...
    {
        return PlayerPrefs.GetString(SERVER_IP_KEY, "your-server.example.com");
    }
